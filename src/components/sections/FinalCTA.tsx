    ...
    <section className="relative py-20 md:py-28 bg-gradient-to-br from-primary/5 via-white to-secondary/5 overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <div className="mt-12 pt-8 border-t border-primary/10 flex items-center justify-center gap-8">
            <a
              href="https://www.instagram.com/tiffanyeg_ips/?hl=es"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-primary hover:text-primary-dark transition-colors font-body font-semibold text-sm no-underline"
