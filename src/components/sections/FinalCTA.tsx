      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-lg text-text-main font-body mb-10 max-w-xl mx-auto">
            Da el primer paso hoy. Agenda tu consulta gratuita y descubre el
            tratamiento ideal para ti con los mejores especialistas.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Button
              ...
              onClick={() =>
                window.open(
                  "https://wa.me/573XXXXXXXXX?text=¡Hola! Quiero agendar mi consulta gratuita.",
                  "_blank"
                )
              }
            >
            ...
            <Button
              ...
              size="lg"
              onClick={() =>
                (window.location.href = "tel:+573XXXXXXXXX")
              }
            >
              Llámanos ahora
            </Button>
