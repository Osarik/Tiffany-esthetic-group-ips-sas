        ...
        >
          ...
          <div className="grid sm:grid-cols-3 gap-6 text-left max-w-2xl mx-auto">
            <a href="https://wa.me/573202703522" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 no-underline group">
              <WhatsAppIcon className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
              <div>
                <p className="font-body font-semibold text-text-dark text-sm group-hover:text-primary transition-colors duration-[300]">
                  WhatsApp
                </p>
