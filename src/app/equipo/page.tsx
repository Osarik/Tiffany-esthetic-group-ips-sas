        ...
        <Container>
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-5">
                ...
                <span className="text-white/70 font-body font-semibold text-xs tracking-[0.2em] uppercase">
                  IPS habilitada · Secretaría de Salud
                </span>
              </div>
              <h1 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl text-white leading-[1.1]">
                Nuestro equipo{" "}
                <span className="text-accent-light">profesional</span>
              </h1>
              <p className="mt-6 text-base md:text-lg text-white/75 font-body leading-relaxed max-w-xl">
                Contamos con cirujanos plásticos miembros de la Sociedad
                Colombiana de Cirugía Plástica (SCCP), anestesiólogos
                certificados por el Consejo de Anestesiología, instrumentación
                quirúrgica, circulante de cirugía, enfermeras recuperadoras
                y un jefe de planta que coordina todo el servicio quirúrgico.
              </p>
            ...
            <div className="lg:col-span-2 relative hidden lg:flex items-center justify-center h-[420px]">
              ...
              <div className="absolute top-6 left-1/2 -translate-x-1/2 w-28 h-28 rounded-2xl bg-white/10 border border-white/20 backdrop-blur-sm flex items-center justify-center animate-[float_6s_ease-in-out_infinite] shadow-xl">
                <svg viewBox="0 0 24 24" width="36" height="36" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2" />
                  <circle cx="12" cy="7" r="4" />
                </svg>
                <span className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-white/60 font-body text-xs whitespace-nowrap font-semibold">Cirujanos</span>
              </div>
              <div className="absolute top-24 left-4 w-24 h-24 rounded-2xl bg-accent/15 border border-accent/20 backdrop-blur-sm flex items-center justify-center animate-[float_8s_ease-in-out_infinite_reverse] shadow-xl">
                <svg viewBox="0 0 24 24" width="30" height="30" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <path d="M22 12h-4l-3 9L9 3l-3 9H2" />
                </svg>
                <span className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-white/60 font-body text-xs whitespace-nowrap font-semibold">Anestesia</span>
              </div>
              <div className="absolute top-20 right-4 w-20 h-20 rounded-2xl bg-white/10 border border-white/20 backdrop-blur-sm flex items-center justify-center animate-[float_7s_ease-in-out_infinite] shadow-xl">
                <svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                </svg>
                <span className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-white/60 font-body text-xs whitespace-nowrap font-semibold">Enfermería</span>
              </div>
              <div className="absolute bottom-16 left-12 w-16 h-16 rounded-2xl bg-white/10 border border-white/20 backdrop-blur-sm flex items-center justify-center animate-[float_9s_ease-in-out_infinite_reverse] shadow-xl">
                <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <rect x="2" y="3" width="20" height="14" rx="2" ry="2" />
                  <line x1="8" y1="21" x2="16" y2="21" />
                </svg>
                <span className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-white/60 font-body text-xs whitespace-nowrap font-semibold">Quirófanos</span>
              </div>
              <div className="absolute bottom-20 right-8 w-14 h-14 rounded-2xl bg-accent/15 border border-accent/20 backdrop-blur-sm flex items-center justify-center animate-[float_10s_ease-in-out_infinite] shadow-xl">
                <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <path d="M10.5 4.5l3-1.5 3 1.5" />
                  <path d="M13.5 3v6" />
                </svg>
                <span className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-white/60 font-body text-xs whitespace-nowrap font-semibold">Farmacia</span>
              </div>
              </div>
            </div>
          </div>
