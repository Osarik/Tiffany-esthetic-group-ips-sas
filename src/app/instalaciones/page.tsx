  ...
  return (
    <>
      ...
      <article>
        ...
        <section className="relative h-[85vh] min-h-[600px] md:min-h-[700px] flex items-end overflow-hidden">
          <div className="absolute inset-0">
            <img
              src="https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=1600&h=1000&fit=crop&crop=entropy&auto=format&q=80"
              alt="Instalaciones quirúrgicas de Tiffany Esthetic Group IPS en Cali"
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0A2A26] via-[#0A2A26]/60 to-transparent" aria-hidden="true" />
            <div className="absolute inset-0 bg-gradient-to-r from-[#0A2A26]/40 to-transparent" aria-hidden="true" />
          </div>
          ...
          <Container>
            ...
            <div className="space-y-10">
              {facilities.map((item, i) => (
                <AnimateInView key={item.title} variant="fadeUp">
